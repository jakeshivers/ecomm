...
# Stripe API key
stripe.api_key = "sk_test_51QUgzKQMkSRKvQW2SKPMp21vrIAtsopsd3Z95FcurgGdiTfYqHBjTHxQUBpPApbcZEqoxkuKotX59LSFnuj7fgLe00xBjXKt5x"

# Kafka configuration
KAFKA_BROKER = "pkc-921jm.us-east-2.aws.confluent.cloud:9092"
KAFKA_TOPIC = "stripe-customers"
...
if __name__ == "__main__":
    main(num_customers=1)  # Change num_customers to generate more
